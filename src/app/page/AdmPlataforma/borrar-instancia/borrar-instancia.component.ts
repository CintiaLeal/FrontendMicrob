...
@Component({
  selector: 'app-borrar-instancia',
  templateUrl: './borrar-instancia.component.html',
  styleUrls: ['./borrar-instancia.component.scss']
})
export class BorrarInstanciaComponent {
...
//FORM desde el HTML
  ...
  DeleteRow(){
    this.api.BorrarInstancias(this.TenantInstanceId).subscribe(data => {
      console.log(data);
    });
    this.alerta.open("Borrada con éxito", "OK!");
  }
}
